...
const toLastNames = people => {
  console.log(people);
  let newArray = people.map (individual => {
...
const addValues = (arr) => {
  ...
  let totalSum = arr.reduce((firstNumber, secondNumber) => {
...
const addPurchases = (arr) => {
  console.log('this is arr', arr);
  let totalSum = arr.reduce((item1 ,item2) => {
    return item1 + item2.purchasePrice;
  }, 0);
  return totalSum;
  // Solution code here...
};
...
const countNumberOfElements = (arr) => {
  console.log('this is arr', arr);
  let numElem = arr.reduce((elem1, elem2) => {
    return elem2;
  }, 0);
  return numElem;
  // Solution code here...
...
const returnNames = (arr) => {
  let starwarsName = arr.reduce ((item1, person) =>{
    item1.push(person.name);
    return item1;
  }, []);
  return starwarsName;
  // Solution code here...
